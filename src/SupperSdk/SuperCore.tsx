...
const init = (params: SupperParams, completion: Function) => {
  if (params && params.appId && params.requestToSuperApp !== null) {
    supperData = params;
    supperData?.requestToSuperApp(supperData.appId, ActionID.initSDK, {data:{}} as IntRequest , completion)
  } else {
    completion(null)
  }
};
...
const willRequestToSupperApp = (
  ...
  if (supperData && supperData.appId) {
    supperData?.requestToSuperApp(supperData.appId, actionID, params, completion);
  }
};
